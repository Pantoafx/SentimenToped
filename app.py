    ...
    if st.button('Analysis'):
        if userText:
            ...
            if lang == 'id':
                ...
                col1.image(image)
                col1.markdown(f"<p style='text-align: center; color: {color}; margin-top: 10px; margin-left: -30px, margin-right: 50px;;'>{sentiment_label.capitalize()}</p>", unsafe_allow_html=True)
